...
contract MasterChef is Ownable {
    ...
    function updatePool(uint256 _pid) public {
       ...
       // pnixs.mint(address(this), pnixsReward);
        ...
        if (user.amount > 0) {
            ...
            if(pending > 0) {
                ...
                if (_withdrawFee>0)
                {
                    ...
                    pnixs.mint(withdrawFeeAddress,_withdrawFee);
 ...
 function _transferReferral(uint256 _referAmountLv1, uint256 _referAmountLv2) internal {
        ...
        if (referrerLv1 != address(0)) {
            uint256 lpStaked = pnixs.balanceOf(referrerLv1);
            if (lpStaked >= stakeAmountLv1 && _referAmountLv1>0 ) {
              
               pnixs.mint(referrerLv1,  _referAmountLv1);
             

                referralAmountLv1[address(pnixs)][address(referrerLv1)] = referralAmountLv1[address(pnixs)][address(referrerLv1)].add(_referAmountLv1);
            ...
            uint256 lpStaked2 = pnixs.balanceOf(referrerLv2);
            if (referrerLv2 != address(0) && lpStaked2 >= stakeAmountLv2   && _referAmountLv2>0 ) {
             
                pnixs.mint(referrerLv2, _referAmountLv2);
               

                referralAmountLv2[address(pnixs)][address(referrerLv2)] = referralAmountLv2[address(pnixs)][address(referrerLv2)].add(_referAmountLv2);
    ...
    function withdraw(uint256 _pid, uint256 _amount) public {
        ...
        if(pending > 0) {
            ...
            pending = pending.sub(referAmountLv1).sub(referAmountLv2);
